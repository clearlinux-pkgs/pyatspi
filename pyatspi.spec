...
Source0  : https://download.gnome.org/sources/pyatspi/2.38/pyatspi-2.38.2.tar.xz
...
%prep
%setup -q -n pyatspi-2.38.2
cd %{_builddir}/pyatspi-2.38.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639507925
...
cp %{_builddir}/pyatspi-2.38.2/COPYING %{buildroot}/usr/share/package-licenses/pyatspi/e8d05da65f87ed0a4a38615cd4f1d9c21cce531b
cp %{_builddir}/pyatspi-2.38.2/COPYING.GPL %{buildroot}/usr/share/package-licenses/pyatspi/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
cp %{_builddir}/pyatspi-2.38.2/tests/pyatspi/pasytest/COPYING-PSF %{buildroot}/usr/share/package-licenses/pyatspi/1cd860a7e028ea38573d27165b529439037321f3
%make_install
